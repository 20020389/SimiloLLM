...
public class SimiloLLMTest
{
	...
	@Test
	public void convertOracles() throws IOException {
		SimiloLLM similoGPT=new SimiloLLM();
		List<Properties> oracles=similoGPT.readCSV("oracles.txt");
        if (oracles == null) {
            throw new IOException("Cannot find oracles.txt");
        }
	...
	@Test
	public void testVONSimiloOutliers()
	{
		Similo similo=new Similo();
		SimiloLLM similoGPT=new SimiloLLM();
...
//				Collections.shuffle(candidates);
	...
	@Test
    public void testVONSimiloLLMWithExplanations()
	{
		Similo similo=new Similo();
		SimiloLLM similoGPT=new SimiloLLM();
...
//				saveImage(capture, "images/app"+app+".png");
	...
	@Test
    public void testLogVisibleText()
	{
		SimiloLLM similoGPT=new SimiloLLM();
	...
	@Test
    public void testLogOracleVisibleText()
	{
		SimiloLLM similoGPT=new SimiloLLM();
